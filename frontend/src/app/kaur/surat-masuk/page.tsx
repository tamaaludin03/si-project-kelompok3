...
export default function KaurSuratMasukPage() {
  ...
  async function loadData() {
    ...
    const [cutiData, izinData] = await Promise.all([
      safeFetch([`${API_BASE_URL}/cuti/kaur/pending${nipQ}`, `${API_BASE_URL}/cuti/kaur/surat-masuk`, `${API_BASE_URL}/cuti/kaur/masuk`]),
      safeFetch([`${API_BASE_URL}/izin/kaur/pending${nipQ}`, `${API_BASE_URL}/izin/kaur/surat-masuk`, `${API_BASE_URL}/izin/kaur/masuk`]),
    ]);
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1.5 text-sm text-slate-400">
                Pengajuan cuti dan izin dari pegawai unit kerja yang menunggu proses persetujuan Anda.
              </p>
            </div>
